...
;; Fix LS_COLORS to have ansi sequences working properly in helm-fd
;; See https://github.com/sharkdp/fd/issues/725.
;; For some reasons calling eval $(dircolors) in ~/.profile is no more
;; working with ubuntu-20+
