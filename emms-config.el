...
(add-hook 'emms-player-started-hook 'tv/xfce-presentation-mode-start)
(add-hook 'emms-player-stopped-hook 'tv/xfce-presentation-mode-stop)
(add-hook 'emms-player-finished-hook 'tv/xfce-presentation-mode-stop)
